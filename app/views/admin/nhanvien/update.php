    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <form method="POST" action="<?=_WEB_ROOT?>/admin/user/update_user/<?=$id?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php } else {?>
                                <input type="radio" name="role" id="" value="1"> Nhân Viên
                                <input type="radio" name="role" id="" value="2" checked> Admin
                            <?php }?>
                        </div>
